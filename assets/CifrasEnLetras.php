...
class CifrasEnLetras {
  ...
  */
  ...
  public static function convertirQuetzalesEnLetras($quetzales, $numeroDecimales=2) {
    return self::convertirNumeroEnLetras($quetzales, $numeroDecimales,
      "quetzal", "quetzales", false, "centavo", "centavos", false);
  }
